        ...
        <div className="flex gap-4 mt-4">
          ...
          <div className="w-1/2">
            <div className="flex gap-2">
              ...
              <h4 className="text-nav-blue font-bold">時間</h4>
            </div>

            <p>2024年12月06日(五) 12:30 ~ 18:00</p>
            <p>2024年12月07日(六) 08:30 ~ 15:30</p>
            <div className="flex gap-2">
              <img src="/address.svg" alt="icon" className="w-8 h-8" />
              <h4 className="text-nav-blue font-bold">地址</h4>
            </div>
            <p>台北市大安區和平東路一段135號</p>
            <div className="flex gap-2">
